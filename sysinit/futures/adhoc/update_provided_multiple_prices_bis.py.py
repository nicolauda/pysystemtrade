...
roll_calendars_from_db = os.path.join(os.sep, 'home', 'nicola', 'data', 'futures', 'roll_calendars_from_db')
if not os.path.exists(roll_calendars_from_db):
    os.makedirs(roll_calendars_from_db)

multiple_prices_from_db = os.path.join(os.sep, 'home', 'nicola', 'data', 'futures', 'multiple_from_db')
if not os.path.exists(multiple_prices_from_db):
    os.makedirs(multiple_prices_from_db)

spliced_multiple_prices = os.path.join(os.sep, 'home', 'nicola', 'data', 'futures', 'multiple_prices_csv_spliced')
...
supplied_file = os.path.join(os.sep, 'home', 'nicola', 'pysystemtrade', 'data', 'futures', 'multiple_prices_csv',
